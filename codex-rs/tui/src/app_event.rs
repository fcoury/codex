...
pub(crate) enum AppEvent {
    ...
    /// Replace the contiguous run of streaming `AgentMessageCell`s at the end
    /// of the transcript with a single `AgentMarkdownCell` that re-renders
    /// from the raw markdown source on resize.
